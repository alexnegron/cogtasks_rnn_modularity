...
def rtantiseqr(**kwargs):
    ...
    env_kwargs['reaction'] = True
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'rtantiseqr'
    return _reach(**env_kwargs)
...
def rtantiseql(**kwargs):
    ...
    env_kwargs['reaction'] = True
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'rtantiseql'
    return _reach(**env_kwargs)
...
def dlygoseqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'dlygoseqr'
    return _reach(**env_kwargs)
...
def dlygoseql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'dlygoseql'
    return _reach(**env_kwargs)
...
def dlygointr(**kwargs):
    ...
    env_kwargs['dly'] = True
    env_kwargs['task_name'] = 'dlygointr'
    return _reach(**env_kwargs)
...
def dlygointl(**kwargs):
    ...
    env_kwargs['integrate'] = -1
    env_kwargs['dly'] = True
    env_kwargs['task_name'] = 'dlygointl'
    return _reach(**env_kwargs)
...
def dlygointseq(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    env_kwargs['task_name'] = 'dlygointseq'
    return _reach(**env_kwargs)
...
def dlyantiseqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'dlyantiseqr'
    return _reach(**env_kwargs)
...
def dlyantiseql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'dlyantiseql'
    return _reach(**env_kwargs)
...
def dlyantiintr(**kwargs):
    ...
    env_kwargs['integrate'] = 1
    #env_kwargs['timing'] = {'delay': 500}
    env_kwargs['task_name'] = 'dlyantiintr'
    return _reach(**env_kwargs)
...
def dlyantiintl(**kwargs):
    ...
    env_kwargs['integrate'] = -1
    #env_kwargs['timing'] = {'delay': 500}
    env_kwargs['task_name'] = 'dlyantiintl'
    return _reach(**env_kwargs)
...
def dlyantiintseq(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    env_kwargs['task_name'] = 'dlyantiintseq'
    return _reach(**env_kwargs)
...
def ctxdm1seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'ctxdm1seqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def ctxdm1seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'ctxdm1seql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def ctxdm2seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'ctxdm2seqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def ctxdm2seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'ctxdm2seql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def multidmseqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'multidmseqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def multidmseql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'multidmseql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def dlydm1seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'dlydm1seqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def dlydm1seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'dlydm1seql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def dlydm1intr(**kwargs):
    env_kwargs = _dlydm_kwargs()
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (True, False)})
    env_kwargs['task_name'] = 'dlydm1intr'
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = 1
    return _DMFamily(**env_kwargs)
...
def dlydm1intl(**kwargs):
    env_kwargs = _dlydm_kwargs()
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (True, False)})
    env_kwargs['task_name'] = 'dlydm1intl'
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = -1
    return _DMFamily(**env_kwargs)
...
def dlydm1intseq(**kwargs):
    env_kwargs = _dlydm_kwargs()
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (True, False)})
    env_kwargs['task_name'] = 'dlydm1intseq'
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = True
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
...
def dlydm2seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'dlydm2seqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def dlydm2seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'dlydm2seql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def dlydm2intr(**kwargs):
    ...
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (False, True)})
    env_kwargs.update(kwargs)
    env_kwargs['task_name'] = 'dlydm2intr'
    env_kwargs['integrate'] = 1
    return _DMFamily(**env_kwargs)
...
def dlydm2intl(**kwargs):
    ...
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (False, True)})
    env_kwargs.update(kwargs)
    env_kwargs['task_name'] = 'dlydm2intl'
    env_kwargs['integrate'] = -1
    return _DMFamily(**env_kwargs)
...
def dlydm2intseq(**kwargs):
    ...
    env_kwargs.update({'w_mod': (1, 1), 'stim_mod': (False, True)})
    env_kwargs.update(kwargs)
    env_kwargs['task_name'] = 'dlydm2intseq'
    env_kwargs['integrate'] = True
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    return _DMFamily(**env_kwargs)
...
def ctxdlydm1seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'ctxdlydm1seqr'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def ctxdlydm1seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'ctxdlydm1seql'
    env_kwargs.update(kwargs)
    return _DMFamily(**env_kwargs)
...
def ctxdlydm1intr(**kwargs):
    ...
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = 1
    env_kwargs['task_name'] = 'ctxdlydm1intr'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm1intl(**kwargs):
    ...
    env_kwargs.update({'w_mod': (1, 0), 'stim_mod': (True, True)})
    env_kwargs.update(kwargs)
    env_kwargs['task_name'] = 'ctxdlydm1intl'
    env_kwargs['integrate'] = -1
    return _DMFamily(**env_kwargs)
...
def ctxdlydm1intseq(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    env_kwargs['task_name'] = 'ctxdlydm1intseq'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm2seqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'ctxdlydm2seqr'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm2seql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'ctxdlydm2seql'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm2intr(**kwargs):
    ...
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = 1
    env_kwargs['task_name'] = 'ctxdlydm2intr'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm2intl(**kwargs):
    ...
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = -1
    env_kwargs['task_name'] = 'ctxdlydm2intl'
    return _DMFamily(**env_kwargs)
...
def ctxdlydm2intseq(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    env_kwargs['task_name'] = 'ctxdlydm2intseq'
    return _DMFamily(**env_kwargs)
...
def multidlydmseqr(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = 1
    env_kwargs['task_name'] = 'multidlydmseqr'
    return _DMFamily(**env_kwargs)
...
def multidlydmseql(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = -1
    env_kwargs['task_name'] = 'multidlydmseql'
    return _DMFamily(**env_kwargs)
...
def multidlydmintr(**kwargs):
    ...
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = 1
    env_kwargs['task_name'] = 'multidlydmintr'
    return _DMFamily(**env_kwargs)
...
def multidlydmintl(**kwargs):
    ...
    env_kwargs.update(kwargs)
    env_kwargs['integrate'] = -1
    env_kwargs['task_name'] = 'multidlydmintl'
    return _DMFamily(**env_kwargs)
...
def multidlydmintseq(**kwargs):
    ...
    env_kwargs['timing'] = {'decision': 1000}
    env_kwargs['seq'] = True
    env_kwargs['task_name'] = 'multidlydmintseq'
    return _DMFamily(**env_kwargs)

#Delay + match family
def _dlymatch(matchto, matchgo, task_name=None, **kwargs):
    envs = list()
    for modality in [0, 1]:
...
def dms(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, task_name='dms', **kwargs)

def dmsintr(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, integrate=1, task_name='dmsintr', **kwargs)

def dmsintl(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, integrate=-1, task_name='dmsintl', **kwargs)

def dnms(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, task_name='dnms', **kwargs)

def dnmsintr(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, task_name='dnmsintr', integrate=1, **kwargs)

def dnmsintl(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, task_name='dnmsintl', integrate=-1, **kwargs)

def dmc(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, task_name='dmc', **kwargs)

def dmcintr(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, task_name='dmcintr', integrate=1, **kwargs)

def dmcintl(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, task_name='dmcintl', integrate=-1, **kwargs)

def dnmc(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, task_name='dnmc', **kwargs)

def dnmcintr(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, integrate=1, task_name='dnmcintr', **kwargs)

def dnmcintl(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, integrate=-1, task_name='dnmcintl', **kwargs)

#seq
def dmsseqr(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, seq=1, timing={'decision': 1000}, task_name='dmsseqr', **kwargs)

def dmsseql(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, seq=-1, timing={'decision': 1000}, task_name='dmsseql', **kwargs)

def dmsintseq(**kwargs):
    return _dlymatch(matchto='sample', matchgo=True, integrate=True, seq=True, timing={'decision': 1000}, task_name='dmsintseq', **kwargs)

def dnmsseqr(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, seq=1, timing={'decision': 1000}, task_name='dnmsseqr', **kwargs)

def dnmsseql(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, seq=-1, timing={'decision': 1000}, task_name='dnmsseql', **kwargs)

def dnmsintseq(**kwargs):
    return _dlymatch(matchto='sample', matchgo=False, integrate=True, seq=True, timing={'decision': 1000}, task_name='dnmsintseq', **kwargs)

def dmcseqr(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, seq=1, timing={'decision': 1000}, task_name='dmcseqr', **kwargs)

def dmcseql(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, seq=-1, timing={'decision': 1000}, task_name='dmcseql', **kwargs)

def dmcintseq(**kwargs):
    return _dlymatch(matchto='category', matchgo=True, integrate=True, seq=True, timing={'decision': 1000}, task_name='dmcintseq', **kwargs)

def dnmcseqr(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, seq=1, timing={'decision': 1000}, task_name='dnmcseqr', **kwargs)

def dnmcseql(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, seq=-1, timing={'decision': 1000}, task_name='dnmcseql', **kwargs)

def dnmcintseq(**kwargs):
    return _dlymatch(matchto='category', matchgo=False, integrate=True, seq=True, timing={'decision': 1000}, task_name='dnmcintseq', **kwargs)